        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Discover luxury venues, premium catering services, and everything you need for your perfect wedding day.
            </p>
          </div>
      ...
      <div className="py-16 px-4 lg:px-8 bg-cream">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {weddingVendors.map((vendor, index) => (
      ...
      <div className="wave-background py-16 px-4 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="section-title">
            <h2 className="text-gray-300">WEDDING</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
            <div className="bg-dark p-6 rounded-xl">
              <div className="flex items-center mb-4">
                ...
                <h4 className="text-white text-xl font-medium">Destination Weddings</h4>
              </div>
              <p className="text-gray-300">
                Exchange vows in breathtaking locations from tropical beaches to historic castles. Let us help plan your dream destination wedding.
              </p>
              <Link to="/ideas/destination-weddings" className="inline-block mt-4 text-gold hover:underline">
                Explore ideas →
              </Link>
            </div>
            ...
            <div className="bg-dark p-6 rounded-xl">
              <div className="flex items-center mb-4">
                <Heart className="text-gold w-8 h-8 mr-3" />
                <h4 className="text-white text-xl font-medium">Rustic & Garden Weddings</h4>
              </div>
              <p className="text-gray-300">
                Create a charming and romantic atmosphere with rustic barn venues or lush garden settings for your special day.
              </p>
              <Link to="/ideas/rustic-garden-weddings" className="inline-block mt-4 text-gold hover:underline">
                Explore ideas →
              </Link>
            </div>
            ...
            <div className="bg-dark p-6 rounded-xl">
              <div className="flex items-center mb-4">
                <Heart className="text-gold w-8 h-8 mr-3" />
                <h4 className="text-white text-xl font-medium">Luxury Weddings</h4>
              </div>
              <p className="text-gray-300">
                Elevate your wedding with opulent venues, gourmet catering, and premium services for an unforgettable luxury celebration.
              </p>
              <Link to="/ideas/luxury-weddings" className="inline-block mt-4 text-gold hover:underline">
                Explore ideas →
              </Link>
            </div>
            ...
            <div className="bg-dark p-6 rounded-xl">
              <div className="flex items-center mb-4">
                <Heart className="text-gold w-8 h-8 mr-3" />
                <h4 className="text-white text-xl font-medium">Cultural Weddings</h4>
              </div>
              <p className="text-gray-300">
                Honor your heritage with traditional ceremonies and celebrations that blend cultural customs with personal touches.
              </p>
              <Link to="/ideas/cultural-weddings" className="inline-block mt-4 text-gold hover:underline">
                Explore ideas →
              </Link>
            </div>
          </div>
